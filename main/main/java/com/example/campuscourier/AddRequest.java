        ...
        buttonPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (null != selectedImageUri) {
                    ...
                    post.put("Image URI", imageStorageUri);
                }
                post.put("Expiry Date", date);
                post.put("Expiry Time", time);
                post.put("Location", location);
                post.put("Urgency", urgency);
                post.put("ID", userId);
                addDataToFirestore(item, description, imageStorageUri, date, time, location, urgency, userId);
//                db.collection("users").document(Objects.requireNonNull(mAuth.getCurrentUser()).getUid()).collection("posts")
//                        .add(post)
...
//                                Toast.makeText(getApplicationContext(), "Request not created. Try again.", Toast.LENGTH_SHORT).show();
//                            }
//                        });
...
//                Requests r = new Requests(item);
    ...
    private void addDataToFirestore(String item, String description, String imageStorageUri, String date, String time, String location, String urgency, String userId) {

        // adding our data to our courses object class.
        Requests r = new Requests(item, description, imageStorageUri, date, time, location, urgency, userId);
